...
public class VermontFlexRoutingTest {
    ...
    public void testFlagStopToRegularStopEndingInDeviatedFixedRoute() {
        ...
        //TODO remove for RTD Flex
        Ride rideTEST = rides.get(0);
        assertEquals("1383", rideTEST.getRoute().getId());
        assertEquals(BoardAlightType.DEFAULT, rideTEST.getBoardType());
        assertEquals(BoardAlightType.DEVIATED, rideTEST.getAlightType());
        checkFare(path);
        //TODO remove this
