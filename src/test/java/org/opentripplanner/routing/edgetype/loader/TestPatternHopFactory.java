...
public class TestPatternHopFactory extends TestCase {
    ...
    public void testTransfers() throws Exception {
        ...
        assertEquals(StopTransfer.UNKNOWN_TRANSFER, transferTable.getTransferTime(stopN, stopM, fromTrip, toTrip, true).getTransferTime());
        assertEquals(StopTransfer.FORBIDDEN_TRANSFER, transferTable.getTransferTime(stopK, stopM, fromTrip, toTrip, true).getTransferTime());
        assertEquals(StopTransfer.PREFERRED_TRANSFER, transferTable.getTransferTime(stopN, stopK, toTrip, toTrip2, true).getTransferTime());
        assertEquals(StopTransfer.TIMED_TRANSFER, transferTable.getTransferTime(stopN, stopK, fromTrip, toTrip, true).getTransferTime());
        assertEquals(15, transferTable.getTransferTime(stopN, stopK, fromTrip, toTrip2, true).getTransferTime());
    ...
    public void testWheelchairAccessible() throws Exception {
        ...
        // stop E has no accessibility information, but GraphIndex's pathways eval should make it not accessible
