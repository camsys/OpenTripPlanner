...
*/
    ...
    private static void assertNoDifferences (Graph g1, Graph g2) {
        ...
        objectDiffer.ignoreFields("incoming", "outgoing", "buildTime", "connectionsFromMap"); // last is ignored since it's a Set and the convey utils don't compare these properly FIXME
        objectDiffer.useEquals(BitSet.class, LineString.class, Polygon.class);
        ...
        // are deduplicated.
        objectDiffer.ignoreClasses(HashGridSpatialIndex.class, ThreadPoolExecutor.class, Deduplicator.class, LIRRSolariDataService.class, RemoteCSVBackedHashMap.class);
