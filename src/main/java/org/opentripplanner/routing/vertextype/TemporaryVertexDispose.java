...
public class TemporaryVertexDispose {
    ...
    public static Collection<Vertex> search(Vertex tempVertex, boolean dispose) {
    ...
    public void search(boolean dispose) {
